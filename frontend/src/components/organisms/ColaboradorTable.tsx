      ...
      <table className="w-full text-left border-collapse">
        <thead className="bg-[var(--yuriana-base-orange)] text-white uppercase text-[10px] font-black tracking-widest">
          <tr>
            ...
            <th className="px-6 py-4">Agencia / Ciudad</th>
            ...
            <tr key={item.id_colaborador} className="hover:bg-slate-50/80 transition-colors">
              <td className="px-6 py-4">
                <div className="flex flex-col">
                  <span className="font-bold text-[var(--yuriana-base-gray-dark)] text-sm">{item.persona.nombre}</span>
                  <span className="text-[10px] text-[var(--yuriana-base-gray-light)] font-black mt-0.5">CI: {item.persona.ci}</span>
                </div>
              </td>
              <td className="px-6 py-4"><ColaboradorTypeBadge type={item.tipo_colaborador} /></td>
              ...
              <td className="px-6 py-4 text-xs text-gray-600 font-medium">{item.persona.telefono}</td>
              <td className="px-6 py-4 font-black text-sm text-[var(--yuriana-base-gray-dark)]">{item.monto.toLocaleString()} Bs</td>
              <td className="px-6 py-4">
