              ...
              <tr key={item.id_gasto_servicio} className="hover:bg-slate-50/80 transition-colors text-xs">
                ...
                <td className="px-4 py-2.5">
                  <div className="flex items-center justify-center gap-4">
                    <button type="button" onClick={() => onView(item)} title="Ver detalle" className="text-[var(--yuriana-base-orange)] hover:scale-110 transition-transform">
                      <Eye size={18} />
                    </button>
                    <button type="button" onClick={() => onEdit(item)} title="Editar" className="text-[var(--yuriana-input-placeholder)] hover:text-slate-600 hover:scale-110 transition-transform">
                      <Pencil size={18} />
                    </button>
                    <button type="button" onClick={() => onDelete(item.id_gasto_servicio)} title="Eliminar" className="text-[var(--yuriana-input-error)] hover:scale-110 transition-transform">
                      <Trash2 size={18} />
                    </button>
                  </div>
                </td>
